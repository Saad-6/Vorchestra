...
public class AddScriptToGroupCommandHandler : IRequestHandler<AddScriptToGroupCommand, ResponseModel<string>>
{
    ...
    public AddScriptToGroupCommandHandler(IScriptGroupService groupScriptService)
    {
    ...
    {
        return await _groupScriptService.AddScriptToGroupAsync(request.ScriptId, request.GroupId, request.Order, cancellationToken);
    }
}
